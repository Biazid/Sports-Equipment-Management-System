...
insert into customer (cc_id,customer_name,address,contact_no) values (106,'Kanon','Khulna',0171623411);

insert into transaction (t_no,ccc_id,eq_id,no_of_equipment,eq_price) values (1,101,201,2,250);
...
insert into transaction (t_no,ccc_id,eq_id,no_of_equipment,eq_price) values (4,104,202,4,450);
insert into transaction (t_no,ccc_id,eq_id,no_of_equipment,eq_price) values (5,105,205,2,500);
insert into transaction (t_no,ccc_id,eq_id,no_of_equipment,eq_price) values (6,106,204,1,600);
